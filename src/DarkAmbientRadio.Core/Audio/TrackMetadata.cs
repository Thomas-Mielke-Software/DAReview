...
public sealed record TrackMetadata
{
    ...
    /// <summary>
    /// Opens the file denying nothing: the player holds the currently playing track open and a
    /// Nextcloud prefetch or a rename may be in flight. TagLib's own abstraction insists on
    /// <see cref="FileShare.Read"/> and would throw in exactly those cases.
    /// </summary>
    private sealed class SharedFileAbstraction : TagLib.File.IFileAbstraction
    {
